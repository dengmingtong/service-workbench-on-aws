...
class IamService extends Service {
  ...
  async syncManagedPolicies(srcRole, targetRole, iamClientForSrcAcc, iamClientForTargetAcc) {
    ...
    // Handle AWS Managed policies first (all AWS managed policy arns have 'aws' in place of account number. E.g., "arn:aws-cn:iam::aws-cn:policy/AmazonEC2FullAccess")
