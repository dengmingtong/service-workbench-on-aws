...
describe('s3 arn helpers', () => {
  const arn1 = 'arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1';
  const arn2 = 'arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1/';
  const arn3 = 'arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1/*';
  const arn4 = 'arn:aws-cn:s3:::bucket-data/a';
  const arn5 = 'arn:aws-cn:s3:::bucket-data/*';
  const arn6 = 'arn:aws-cn:s3:::bucket-data/';
  const arn7 = 'arn:aws-cn:s3:::bucket-data';
  ...
  describe('parseS3Arn', () => {
    it('it returns undefined if it can not parse the arn', () => {
      ...
      expect(parseS3Arn('arn:aws-cn:sms')).toBeUndefined();
      expect(parseS3Arn('arn:aws-cn:s3')).toBeUndefined();
      expect(parseS3Arn('arn:aws-cn:s3:::')).toBeUndefined();
    });
  ...
  describe('normalizeS3Arn', () => {
    it('Should return correct arn with a forward slash at end', () => {
      expect(normalizeS3Arn(arn1)).toEqual('arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1/');
      expect(normalizeS3Arn(arn2)).toEqual('arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1/');
      expect(normalizeS3Arn(arn3)).toEqual('arn:aws-cn:s3:::bucket-data/users/example@example.com/my-study-1/');
      expect(normalizeS3Arn(arn4)).toEqual('arn:aws-cn:s3:::bucket-data/a/');
      expect(normalizeS3Arn(arn5)).toEqual('arn:aws-cn:s3:::bucket-data/');
      expect(normalizeS3Arn(arn6)).toEqual('arn:aws-cn:s3:::bucket-data/');
      expect(normalizeS3Arn(arn7)).toEqual('arn:aws-cn:s3:::bucket-data/');
  ...
  describe('normalizeBucketArn', () => {
    it('Should return correct arn without folder', () => {
      expect(normalizeBucketArn(arn1)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn2)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn3)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn4)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn5)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn6)).toEqual('arn:aws-cn:s3:::bucket-data');
      expect(normalizeBucketArn(arn7)).toEqual('arn:aws-cn:s3:::bucket-data');
  ...
  describe('toS3Arn', () => {
    it('Should return correct S3 arn', () => {
      expect(toS3Arn({ bucket: 'bucket-data', awsPartition: 'aws', folder: '/' })).toEqual('arn:aws-cn:s3:::bucket-data/');
      expect(
